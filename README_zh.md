...
> 如果觉得我的代码有帮助的话，可以的话给我点个星星噢，非常感谢！🌟
...
4. **webshare**：需要自行去https://www.webshare.io/购买旋转住宅ip，10w+ip可用，一个月不到30，前提是需要使用美金卡进行购买，也可以联系作者qq帮忙购买：3178436095。
5. **c5账号批量绑定steam**：由于c5客服一直不给解决方案，目前脚本在批量绑定后，会显示登录信息失效，需要重新登录，故此功能暂不可用，后续可能会根据c5客服指引而修复。

---

## 📄 开源协议
MIT License. **仅供学习与安全研究使用。** 使用自动化脚本需严格遵守 Steam 用户协议。
...
> 此项目耗时不超过一个月，仅为作者课余时间所写，其中绝大部分代码由 agent 生成，在此由衷感谢 Antigravity 给我带来的帮助。
